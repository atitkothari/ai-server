...
from saicinpainting.training.modules.pix2pixhd import MultiDilatedGlobalGenerator
from saicinpainting.training.modules.pix2pixhd import MultidilatedNLayerDiscriminator
